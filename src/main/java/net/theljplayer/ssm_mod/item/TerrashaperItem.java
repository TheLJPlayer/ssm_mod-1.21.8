...
import net.theljplayer.ssm_mod.entity.projectile.TerrashaperEntity;

public class TerrashaperItem extends Item implements ProjectileItem {
  ...
  public TerrashaperItem(ToolMaterial material, float attackDamage, float attackSpeed, Item.Settings settings) {
        ...
        if (f > 0.0F && !playerEntity.isTouchingWaterOrRain()) {
          ...
          if (world instanceof ServerWorld serverWorld) {
            ...
            if (f == 0.0F) {
              ...
              TerrashaperEntity terrashaperEntity = ProjectileEntity.spawnWithVelocity(TerrashaperEntity::new, serverWorld, itemStack, playerEntity, 0.0F, 2.5F, 1.0F);
              if (playerEntity.isInCreativeMode()) {
                terrashaperEntity.pickupType = PersistentProjectileEntity.PickupPermission.CREATIVE_ONLY;
              }

              world.playSoundFromEntity(null, terrashaperEntity, registryEntry.value(), SoundCategory.PLAYERS, 1.0F, 1.0F);
              return true;
            }
          }
  ...
  public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
    TerrashaperEntity terrashaperEntity = new TerrashaperEntity(world, pos.getX(), pos.getY(), pos.getZ(), stack.copyWithCount(1));
    terrashaperEntity.pickupType = PersistentProjectileEntity.PickupPermission.ALLOWED;
    return terrashaperEntity;
  }
}