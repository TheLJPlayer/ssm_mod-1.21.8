package net.theljplayer.ssm_mod.entity.projectile;
...
public class TerrashaperEntity extends PersistentProjectileEntity {
	private static final TrackedData<Byte> LOYALTY = DataTracker.registerData(TerrashaperEntity.class, TrackedDataHandlerRegistry.BYTE);
	private static final TrackedData<Boolean> ENCHANTED = DataTracker.registerData(TerrashaperEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
	private static final float DRAG_IN_WATER = 0.99F;
	private static final boolean DEFAULT_DEALT_DAMAGE = false;
	private boolean dealtDamage = false;
	public int returnTimer;

	public TerrashaperEntity(EntityType<? extends TerrashaperEntity> entityType, World world) {
		super(entityType, world);
	}

	public TerrashaperEntity(World world, LivingEntity owner, ItemStack stack) {
		super(EntityType.TRIDENT, owner, world, stack, null);
		this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
		this.dataTracker.set(ENCHANTED, stack.hasGlint());
	}

	public TerrashaperEntity(World world, double x, double y, double z, ItemStack stack) {
	...
	protected ItemStack getDefaultItemStack() {
		return new ItemStack(ModItems.TERRASHAPER);
	}
